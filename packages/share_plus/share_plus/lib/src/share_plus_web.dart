  ...
  Future<void> shareUri(
    ...
    try {
      ...
      if (e.name == 'TypeError') {
        ...
        developer.log(
          'Unexpected error when checking if sharing uri is available',
          error: '${e.name}: ${e.message}',
        );
      }
  ...
  Future<ShareResult> shareWithResult(
    ...
    try {
      ...
      if (e.name == 'TypeError') {
        ...
        developer.log(
          'Unexpected error when checking if sharing text is available',
          error: '${e.name}: ${e.message}',
        );
      }
  ...
  Future<ShareResult> shareXFiles(
    ...
    try {
      ...
      if (e.name == 'TypeError') {
        ...
        developer.log(
          'Unexpected error when checking if sharing files is available',
          error: '${e.name}: ${e.message}',
        );
      }
